...
do
/WAVE/projects/COEN-319-Sp20/hchen7/hw2/matmult/matmult_omp 5000 50000 5000 $tile_size $thread_num >> /WAVE/projects/COEN-319-Sp20/hchen7/hw2/logs/$log_file_name
done